...
#define ADMIN_ADD_CUSTOMER_NAME "What is the  name?"
#define ADMIN_ADD_CUSTOMER_GENDER "What is the gender?\nEnter M for male, F for female and O for others"/
#define ADMIN_ADD_CUSTOMER_AGE "What is the  age?"
#define ADMIN_ADD_CUSTOMER_AUTOGEN_LOGIN "The autogenerated login ID is : "
//#define AUTOGEN_PASSWORD "spookytime" // append to end of next string macro
#define ADMIN_ADD_CUSTOMER_AUTOGEN_PASSWORD "The autogenerated password is : "
...
#define ADMIN_MOD_CUSTOMER_ID "Enter the ID of who's information you want to edit"
